		...
		<section className="relative min-h-screen flex items-center justify-center overflow-hidden">
			...
			<div className="relative z-10 text-center px-4">
				<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
					<h1 className="text-5xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500">Pascal Simon</h1>
					<p className="text-xl md:text-2xl text-gray-300 mb-8">Frontend Developer with Full-Stack Experience</p>
					<div className="flex flex-wrap justify-center gap-4 text-sm">
						<span className="px-4 py-2 bg-blue-500/10 rounded-full border border-blue-500/20">React Native</span>
						...
						<span className="px-4 py-2 bg-blue-500/10 rounded-full border border-blue-500/20">Flask</span>
						<span className="px-4 py-2 bg-blue-500/10 rounded-full border border-blue-500/20">MongoDB</span>
						<span className="px-4 py-2 bg-blue-500/10 rounded-full border border-blue-500/20">PostgreSQL</span>
						<span className="px-4 py-2 bg-blue-500/10 rounded-full border border-blue-500/20">Docker</span>
						<span className="px-4 py-2 bg-blue-500/10 rounded-full border border-blue-500/20">Git</span>
						<span className="px-4 py-2 bg-blue-500/10 rounded-full border border-blue-500/20">Chai</span>
						<span className="px-4 py-2 bg-blue-500/10 rounded-full border border-blue-500/20">Mocha</span>
					</div>
				</motion.div>
			</div>
